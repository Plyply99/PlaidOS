...
### Install packages
dnf5 -y install adw-gtk3-theme akmods bat bat-extras btop cava chafa distrobox emacs eza fastfetch fzf gdm gh ghostty gnome-software gnome-software-rpm-ostree htop input-remapper kernel-devel kitty libva-utils mangohud mpv nautilus nodejs24 rpmdevtools steam-devices vkBasalt xwininfo --allowerasing
