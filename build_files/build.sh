...
dnf5 -y install steam-devices distrobox mpv input-remapper mangohud vkBasalt adw-gtk3-theme bat bat-extras btop chafa emacs eza fastfetch gamemode ghostty htop xwininfo libva-utils 
